...
namespace backend.Models
{
    ...
    public partial class TbCarro
    {
        ...
        [Column("bt_usado", TypeName = "tinyint(4)")]
        public sbyte BtUsado { get; set; }
        [Required]
        ...
        [Column("nr_km", TypeName = "int(11)")]
        public int? NrKm { get; set; }
        [Column("ds_cor", TypeName = "varchar(50)")]
        public string DsCor { get; set; }
        [Column("bt_arcondicionado", TypeName = "tinyint(4)")]
        public sbyte? BtArcondicionado { get; set; }
